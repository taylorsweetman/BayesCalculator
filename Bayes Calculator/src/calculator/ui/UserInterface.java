...
public class UserInterface implements Runnable {
	...
	private void createComponents(Container container) {
		...
		CalculateListener calcButtonListener = new CalculateListener(aGivenBInput, aInput, bInput, bGivenAInput, calculateButton);
		ClearListener clearButtoneListener = new ClearListener(aGivenBInput, aInput, bInput, bGivenAInput);
		calculateButton.addActionListener(calcButtonListener);
		clearButton.addActionListener(clearButtoneListener);
	}

	@Override
	public void run() {
		frame = new JFrame("Bayes Calculator");
